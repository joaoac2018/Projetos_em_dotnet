using System;
// IMPLEMENTAR MELHORIAS DE FLUXO E FUNCIONALIDADES
namespace cadastroSeries
{
    class Program
    {
        ...
        {
            Console.WriteLine("Inserir nova série no catálogo");

            foreach(int i in Enum.GetValues(typeof(Genero)))
            {
                Console.WriteLine("{0}-{1}", i, Enum.GetName(typeof(Genero), i));
            }
            Console.Write("Digite o número que corresponde ao genero entre as opções acima: ");
        ...
        {
            Console.WriteLine();
            Console.WriteLine("> Cine Series a seu dispor <");
